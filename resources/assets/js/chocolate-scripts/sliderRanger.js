                            ...
                            success: function(res){
                                ...
                                console.log(res);
                                   ...
                                   $.each(res.products, function(i, product) {
                                       ...
                                       // console.log(product);
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="product-box">
                                                <div class="img"><img src="http://localhost:8000/front_assets/images/product-img/${product.product_image}" alt="" /></div>
                                                <div class="product-detail">
                                                    <div class="name"><strong>${product.product_title} </strong></div>
                                                    <div class="rating">
                                    ...
                                    if(res.products){
                                        $('#shop_box_product').html(responseProduct);
                                    }
